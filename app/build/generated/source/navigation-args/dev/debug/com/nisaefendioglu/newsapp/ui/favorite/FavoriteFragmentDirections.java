package com.nisaefendioglu.newsapp.ui.favorite;
...
public class FavoriteFragmentDirections {
  ...
  public static ActionFavoriteFragmentToDetailsFragment actionFavoriteFragmentToDetailsFragment(
    ...
    return new ActionFavoriteFragmentToDetailsFragment(news, isFromFavorite);
  }
  ...
  public static class ActionFavoriteFragmentToDetailsFragment implements NavDirections {
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionFavoriteFragmentToDetailsFragment setIsFromFavorite(boolean isFromFavorite) {
      this.arguments.put("isFromFavorite", isFromFavorite);
      return this;
    }
