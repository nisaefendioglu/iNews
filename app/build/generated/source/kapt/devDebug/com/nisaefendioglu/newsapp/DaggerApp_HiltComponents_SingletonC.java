...
import com.nisaefendioglu.newsapp.di.ApplicationModule_ProvideApiHelperFactory;
import com.nisaefendioglu.newsapp.di.ApplicationModule_ProvideDatabaseFactory;
import com.nisaefendioglu.newsapp.di.ApplicationModule_ProvideNewsApiFactory;
import com.nisaefendioglu.newsapp.di.ApplicationModule_ProvideNewsDaoFactory;
import com.nisaefendioglu.newsapp.di.ApplicationModule_ProvideOkHttpClientFactory;
import com.nisaefendioglu.newsapp.di.ApplicationModule_ProvideRepositoryFactory;
import com.nisaefendioglu.newsapp.di.ApplicationModule_ProvideRetrofitFactory;
...
import com.nisaefendioglu.newsapp.ui.main.MainViewModel_HiltModules_KeyModule_ProvideFactory;
...
public final class DaggerApp_HiltComponents_SingletonC extends App_HiltComponents.SingletonC {
  ...
  private Provider<DAO> provideNewsDaoProvider;
  ...
  private Retrofit retrofit() {
    return ApplicationModule_ProvideRetrofitFactory.provideRetrofit(provideOkHttpClientProvider.get());
  }

  private NewsApi newsApi() {
    return ApplicationModule_ProvideNewsApiFactory.provideNewsApi(provideRetrofitProvider.get());
  }
  ...
  private LocalDatabase localDatabase() {
    return ApplicationModule_ProvideDatabaseFactory.provideDatabase(ApplicationContextModule_ProvideContextFactory.provideContext(applicationContextModule));
  }

  private DAO dAO() {
    return ApplicationModule_ProvideNewsDaoFactory.provideNewsDao(provideDatabaseProvider.get());
  }

  private NewsRepository newsRepository() {
    return ApplicationModule_ProvideRepositoryFactory.provideRepository(provideApiHelperProvider.get(), provideNewsDaoProvider.get());
  }
  ...
  private void initialize(final ApplicationContextModule applicationContextModuleParam) {
    ...
    this.provideDatabaseProvider = DoubleCheck.provider(new SwitchingProvider<LocalDatabase>(singletonC, 6));
    this.provideNewsDaoProvider = DoubleCheck.provider(new SwitchingProvider<DAO>(singletonC, 5));
    this.provideRepositoryProvider = DoubleCheck.provider(new SwitchingProvider<NewsRepository>(singletonC, 0));
    this.networkHelperProvider = DoubleCheck.provider(new SwitchingProvider<NetworkHelper>(singletonC, 7));
  }
  ...
  private static final class ViewModelCImpl extends App_HiltComponents.ViewModelC {
    ...
    private MainViewModel mainViewModel() {
      return new MainViewModel(singletonC.provideRepositoryProvider.get(), singletonC.networkHelperProvider.get(), new CoroutinesDispatcherProvider());
    }
    ...
    public Map<String, Provider<ViewModel>> getHiltViewModelMap() {
      return Collections.<String, Provider<ViewModel>>singletonMap("com.nisaefendioglu.newsapp.ui.main.MainViewModel", (Provider) mainViewModelProvider);
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.nisaefendioglu.newsapp.ui.main.MainViewModel 
  ...
  private static final class SwitchingProvider<T> implements Provider<T> {
    ...
    public T get() {
      switch (id) {
        case 0: // com.nisaefendioglu.newsapp.network.repository.NewsRepository 
        return (T) singletonC.newsRepository();

        case 1: // com.nisaefendioglu.newsapp.api.ApiHelper 
        return (T) singletonC.apiHelper();

        case 2: // com.nisaefendioglu.newsapp.api.NewsApi 
        ...
        case 5: // com.nisaefendioglu.newsapp.data.DAO 
        return (T) singletonC.dAO();

        case 6: // com.nisaefendioglu.newsapp.data.LocalDatabase 
        return (T) singletonC.localDatabase();

        case 7: // com.nisaefendioglu.newsapp.utils.NetworkHelper 
